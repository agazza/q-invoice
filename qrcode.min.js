...
(function () {
  ...
  QRCode.prototype._getUTF8Length = function (sText) {
  ...
  QRCode.prototype._createCanvas = function () {
    ...
    for (var row = 0; row < nCount; row++) {
      aHTML.push('<tr style="border:0;border-collapse:collapse;margin:0;padding:0;height:' + nHeight + 'px">');

      for (var col = 0; col < nCount; col++) {
        aHTML.push('<td style="border:0;border-collapse:collapse;margin:0;padding:0;width:' + nWidth + 'px;background-color:' + (this._oQRCode.isDark(row, col) ? this._htOption.colorDark : this._htOption.colorLight) + '"></td>');
      }
